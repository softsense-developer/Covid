...
export default {
   data: () => ({
      ...
      userId:null,
      links :[
          {icon: 'fas fa-home', text:'Anasayfa', route: '/supervisorhome'},
          {icon: 'fas fa-hospital', text:'Hastane', route: '/supervisorhospital'},
          {icon: 'fas fa-user', text:'Doktorlar', route: '/supervisordoctors'},
          {icon: 'fas fa-map', text:'Harita', route: '/supervisormaps'},
        //   {icon: 'dashboard', text:'Uyarılar', route: '/doctorwarnings'},
        //   {icon: 'dashboard', text:'İstekler', route: '/doctorrequiests'},
