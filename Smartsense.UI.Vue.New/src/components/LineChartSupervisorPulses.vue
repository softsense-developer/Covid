<template>
  <div class="container">
    <div class="row">
      ...
      <a  class="badge text-white mt-1 ml-1 filter-days" @click="changefilterdays()" data-toggle="modal" data-target="#exampleModalThree"  style="cursor:pointer;border:none;background:grey;">Tarih aralığı seç</a>
...
export default {
  ...
  methods: {
    ...
    getFavoriotLastWeek() {
      var filter_days=document.querySelector('.filter-days')
    ...
    changefilterdays() {
      ...
      last_week.style.backgroundColor='#BDBDBD'
      last_day.style.backgroundColor='#BDBDBD'
      filter_days.style.backgroundColor='#ef5350'
      today.style.backgroundColor='#BDBDBD'
    },
    getFavoriotLastDay() {
      var filter_days=document.querySelector('.filter-days')
