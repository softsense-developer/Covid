<template>
  <div class="container">
    <div class="row">
      ...
      <a  class="badge text-white mt-1 ml-1 filter-day" @click="changefilterday()" data-toggle="modal" data-target="#exampleModalOxygen"  style="cursor:pointer;border:none;background:grey;">Tarih aralığı seç</a>
      <div class="modal fade" id="exampleModalOxygen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div >
      <div class="container">
        <div class="row nodatacard" style="display:none;">
...
export default {
  ...
  methods: {
    ...
    GlobalRequiest(x,y) {
      ...
      var url="http://api.smartsense.com.tr/api/supervisor/getpatienthistorydaterange";
      var jsonObject={
        ...
        headers:{'Authorization': `Bearer ${token}`}
            ...
            if(res.data.code == "200") {
              ...
              // alert('hello')
              var getir=document.querySelector("#myChartPulsess");
              getir.style.display="none";
              var nodatacardx=document.querySelector(".nodatacard");
              nodatacardx.style.display="block"
              
            }else {
              var getirx=document.querySelector("#myChartPulsess");
              getirx.style.display="block";
              var nodatacard=document.querySelector(".nodatacard");
