      ...
      <v-navigation-drawer  v-model="drawer" dark app class="green darken-4">
          <v-layout column align-center>
               <v-flex class="mt-5"> 
                    ...
                    <p class="white--text subheading mt-1 text-center">Dr.{{name}} {{surname}}</p>
...
export default {
   data: () => ({
      ...
      userId:null,
      links :[
          {icon: 'fas fa-home', text:'Anasayfa', route: '/doctorhome'},
          {icon: 'fas fa-bell', text:'Uyarılar', route: '/doctorwarnings'},
          {icon: 'fas fa-exclamation-circle', text:'İstekler', route: '/doctorrequiests'},
          {icon: 'fas fa-user', text:'Hesap', route: '/changepassdoctor'},
           {icon: 'fas fa-map', text:'Konum', route: '/doctormaps'},
