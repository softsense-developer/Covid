<template>
  <div>
    <Navbar/>
    <h1 class="subheading grey--text !important">Anasayfa</h1>
      <div class="container">
              ...
              <table class="table table-borderless">
                ...
                <tbody>
                  <tr v-for="pat of doc.hastalarInfoModels" :key="pat.hastaId">
                    ...
                    <td>
                        <span class="pointer" v-if="pat.temperatureWarning==1" ><i class="fas fa-fire" style="color:#EF9A9A"></i></span>
                        <span class="pointer-fast" v-if="(pat.temperatureWarning==0)||(pat.temperatureWarning==2)"  ><i class="fas fa-fire" style="color:#E57373"></i></span>
               ...
               <td><a class="text-dark" @click="goTodetail(pat.hastaId)" style="font-size:15px" ><i class="fas fa-info-circle" ></i></a></td>
                  </tr>
                </tbody>
              </table>
              </div>
...
export default {
    ...
    methods:{
      ...
      this.$router.push({name:'detailsupervisor',params:{Pid:prodId}})
    },
