      ...
      <div class="container" >
        <div class="row">
          <div class="col-sm-4 col-md-4 col-lg-4">
            <div class="small-box bg-success text-white text-center"  v-if="nulldata == true">
                  <div class="inner">
                ...
                <div class="small-box bg-success text-white text-center"  v-if="nulldata == false">
                  <div class="inner">
                    <!-- <h3 v-if="nulldata">{{lastValueOxygen.dataValue}}</h3> -->
                    <p>veriniz bulunmamaktadır</p>
                    <p>Son spo2 verisi</p>
                  </div>
                  <div class="icon">
                    <i class="ion ion-bag"></i>
          ...
          <div class="col-sm-4 col-md-4 col-lg-4" >
            <div class="small-box bg-danger text-white text-center" v-if="nulldata == true">
                  <div class="inner">
                ...
                <div class="small-box bg-danger text-white text-center" v-if="nulldata == false">
                  <div class="inner">
                    <p>veriniz bulunmamaktadır</p>
                    <p>Son nabız verisi</p>
                  </div>
          ...
          <div class="col-sm-4 col-md-4 col-lg-4">
            <div class="small-box  text-white text-center" style="background:#fd7e14" v-if="nulldata == true">
                  <div class="inner">
                ...
                <div class="small-box  text-white text-center" style="background:#fd7e14" v-if="nulldata == false">
                  <div class="inner">
                    <p>veriniz bulunmamaktadır</p>
                    <p>Son sıcaklık verisi</p>
                  </div>
...
import LineChart from '../components/LineChartSupervisor.vue'
import LineChartPulses from '../components/LineChartSupervisorPulses.vue'
import LineChartTemp from '../components/LineChartSupervisorTemperatures.vue'
export default {
  name:"mainSide",
  data() {
    return {
