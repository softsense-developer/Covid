        ...
        <div class="col-sm-12 col-md-12 col-lg-12"  v-for="(patientsdata,index) in patientsData" :key="index">
          <div class="card card-head" style="margin-bottom:0 !important;border: 1px solid rgb(149, 224, 153); ">
            <div class="d-flex justify-content-between" style="align-items:center">
              <i class="fas fa-info-circle text-white ml-5" style="font-size:15px;cursor:pointer;" @click="goTodetail(patientsdata.id)"> Profili görüntüle</i>
              <div class=" a " style="cursor:pointer;"><i class="fas fa-trash-alt text-white m-2 mr-5" style="font-size:25px" data-toggle="modal" data-target="#exampleModal" @click="deletepatientlocal(index,patientsdata.id)"></i>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-success" data-dismiss="modal" @click="deletestorage()">İptal</button>
                      <button type="button" class="btn btn-outline-danger " @click="deletePatient()">Evet</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <!-- question title -->
          <div class="question-title" >
            <div class="container">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-11 d-flex justify-content-end " style="align-items:center">
        ...
        <!-- question text -->
          <div class="question-text">
            <div class="container-fluid">
              <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-6 d-flex justify-content-start">
                  <div class="list-group w-100">
                 <div href="#" class="list-group-item first-item text-white d-flex d-flex justify-content-between">
                   merhaba
                   <div>
                      <i class="far fa-trash-alt mr-2" @click="deleteMedicineTime(medicineTimeModels.medicineTimeId,medicines.medicineTimeModels,index)"></i>
                      <!-- <i class="far fa-edit"></i> -->
                   </div>
                  </div>
                 <div href="#" class="list-group-item text-dark">hello</div>
                 </div>  
                </div>
              </div>
            </div> 
